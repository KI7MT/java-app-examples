...
public class DomainPurchsaeDriver
{
	...
	public static void main(String[] args)
	{
		...
		ArrayList<IPayable> invoiceList = new ArrayList<IPayable>();
		...
		{
			System.out.println(invoiceList.get(counter));
			System.out.printf("Amount Due..: $%.2f", invoiceList.get(counter).getTotalDue());
			System.out.println("\n");
		}
	...
	{
		Random rand = new Random();
		double ranValueDouble = rand.nextDouble() + (max - min);
	
		return ranValueDouble;
	}
